...
const Page = ({ children }) => {
  ...
  <div className="flex flex-col h-screen">
    ...
    <div className="flex mt-20 flex-1">
      ...
      <aside
        ref={sidebarRef}
        className={`z-40 flex flex-col justify-between md:w-72 w-64 fixed h-full transform transition-transform duration-300 ease-in-out bg-[#2E2E48] shadow-lg ${
      ...
      {/* Main content */}
      <div className="flex-1 bg-[#383854] p-4 md:p-6  2xl:max-w-7xl mr-auto lg:ml-20 xl:80 xl:ml-96">
        {children}
      </div>
    </div>
  </div>
